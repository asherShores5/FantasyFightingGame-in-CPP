> **📦 Archived original.** This directory preserves the original 2020 C++ console game
> exactly as it was, along with its original README (below). The project has since been ported
> to a static JavaScript web app — see the [root README](../README.md). The C++ build
> instructions below still work if you want to compile the classic version.
